...
set csv_path to "/Volumes/Documents/Users/tnip/Documents/cs421-roster-20160118-orig.csv"
...
repeat with student_record in l
	set netid to item 1 in student_record
	set ct to 0
	tell application "Google Chrome"
		open location domain & "/cs421-sp2016/" & netid & "/project_members"
		tell active tab of window 1
			repeat while loading is true
				delay 0.1
			end repeat
			execute javascript "document.getElementById('user_ids').value=\"" & netid & "@illinois.edu\";
			  			         document.getElementById('access_level').value=\"30\"
			  			         document.getElementById('new_project_member').submit();"
			delay 0.2
